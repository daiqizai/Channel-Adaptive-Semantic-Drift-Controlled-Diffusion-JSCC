...
- `s6_minimal_closure_report.yaml`：聚合 M0、M1、`EXP-S4-006` residual M2/M3、residual shrink schedule、adaptive/two-stage residual alpha policy 和 test-like 语义审计，生成第一版最小论文闭环报告与 tradeoff 图。
